...
- 最上層使用 tab 分成 `General`、`AI Provider`、`Notifications`、`Starter`、`Agent Flow`。
...
|                                                                                |
| [General] [AI Provider] [Notifications] [Starter] [Agent Flow]                |
|                                                                                |
| General                                                                        |
...
flowchart TD
  ...
  D -- Switch tab --> G[Open General / Provider / Notifications / Starter / Flow tab]
